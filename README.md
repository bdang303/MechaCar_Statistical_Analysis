...
[!Multiple linear regression model] (URL) 
...
We’d use a 2-sample t test to determine this, as well as data from various vehicle manufactures in order to understand the total costs & time it takes to get these vehicles from concept to road. 
